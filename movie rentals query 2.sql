-- =====================================
-- week4_reports_fixed_final_tables.sql
-- =====================================

PRAGMA foreign_keys = ON;

-- Drop existing tables safely
DROP TABLE IF EXISTS top_customers_ytd_1;
DROP TABLE IF EXISTS repeat_rentals_1;
DROP TABLE IF EXISTS movie_utilization_1;
DROP TABLE IF EXISTS store_revenue_share_1;
DROP TABLE IF EXISTS customer_retention_1;
DROP TABLE IF EXISTS seasonal_rentals_1;
DROP TABLE IF EXISTS top_genres_per_store_1;

-- =====================================
-- Top customers by revenue (YTD)
-- =====================================
CREATE TABLE top_customers_ytd_1 AS
SELECT 
    c.customer_id,
...
-- =====================================
CREATE TABLE repeat_rentals_1 AS
SELECT 
    c.customer_id,
    c.name AS customer_name,
    m.movie_id,
...
-- Movie utilization
-- =====================================
CREATE TABLE movie_utilization_1 AS
SELECT 
    m.movie_id,
    m.title,
...
-- Store revenue share (%)
-- =====================================
CREATE TABLE store_revenue_share_1 AS
...
-- =====================================
-- Customer retention (rentals within 90 days simplified)
-- =====================================
CREATE TABLE customer_retention_1 AS
SELECT 
    c.customer_id,
    c.name,
    COUNT(r.rental_id) AS total_rentals
...
-- =====================================
-- Seasonal rentals by date/quarter
-- =====================================
CREATE TABLE seasonal_rentals_1 AS
SELECT 
    r.date_id,
    COUNT(r.rental_id) AS total_rentals
FROM rentals_1 r
...
-- =====================================
-- Top genres per store (ranked)
-- =====================================
CREATE TABLE top_genres_per_store_1 AS
SELECT
    s.store_id,
    s.name AS store_name,
    m.genre,
